...
export const SPLITABLE_ROUTES: SplitableRoute[] = [
    ...
    { path: '/production/orders', label: 'nav.productionOrders' },
    { path: '/production/lines', label: 'nav.productionLines' },
    { path: '/production/panels', label: 'nav.panels' },
    { path: '/production/panel-models', label: 'nav.panelModels' },
