...
const TONE: Record<KpiTone, { chip: string; value: string }> = {
    brand: { chip: 'bg-[#0052b8]/8 text-[#0052b8] dark:bg-[#e6cf9e]/12 dark:text-[#e6cf9e]', value: 'text-[#0052b8] dark:text-[#e6cf9e]' },
        ...
        <AntdTheme>
            <div
                ...
                className={cx(
                    ...
                    onClick &&
                        'cursor-pointer transition-colors duration-150 hover:border-[#C9D0DF] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0052b8]/25',
                )}
            >
