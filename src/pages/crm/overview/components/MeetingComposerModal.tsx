...
const inputCls =
    'rounded-xl border border-black/10 bg-white px-3 py-2 text-[13.5px] outline-none transition-colors focus:border-[#0052b8]/50 dark:border-white/15 dark:bg-white/5 dark:text-white';
                    ...
                    <div className="flex flex-col gap-1.5">
                        <span className="flex items-center justify-between text-[12.5px] font-medium text-[#3F4350] dark:text-[#d9dce3]">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1 rounded-lg border border-[#0052b8]/25 px-2 py-1 text-[12px] font-semibold text-[#0052b8] transition-colors hover:bg-[#0052b8]/5 dark:border-[#e6cf9e]/30 dark:text-[#e6cf9e] dark:hover:bg-[#e6cf9e]/10"
                            >
                                <Plus size={13} />
