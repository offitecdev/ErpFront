                    ...
                    <tbody>
                        ...
                        {!loading && paged.map(({ order, totals }) => {
                            ...
                            return (
                                ...
                                <tr className="cursor-pointer transition-colors hover:bg-slate-50 dark:hover:bg-white/5" onClick={() => navigate(`/crm/my-orders/${order.id}`)}>
                                    <td>
                                ...
                                {addons.map((addon) => {
                                    ...
                                    return (
                                        <tr
                                            ...
                                            onClick={() => navigate(`/crm/my-orders/${order.id}?tab=addons&addon=${addon.id}`)}
                                        >
                                            <td>
