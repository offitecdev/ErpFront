...
/**
 * Satın alma listesi: sunucu sayfalı, genel arama + durum/tedarikçi/tarih
 * filtreleri. `kind` hangi MODÜLÜN listelendiğini söyler — fiyat talepleri ve
 * siparişler 22.09.2026'dan beri iki ayrı listedir.
 */
export const useOrdersList = (kind: PurchaseKind) => {
    ...
    useEffect(() => { setPage(1); }, [kind, debouncedSearch, status, dateFrom, dateTo, debouncedFilters]);
    ...
    }, [kind, page, debouncedSearch, status, dateFrom, dateTo, debouncedFilters, reloadTick]);
