...
/**
 * Dedicated route for `/sales/quotes/new`. Auto-creates a draft tender (falling
...
export const TenderCreate = () => {
    ...
    // from that customer's panel via `/sales/quotes/new?customerId=<id>`).
    ...
    useEffect(() => {
        ...
        createTender({ format: 'SIA451', validUntil, customerId })
            .then((created) => {
                ...
                navigate(`/sales/quotes/${created.id}`, { replace: true, state: { autoSaveOnExit: true } });
            })
