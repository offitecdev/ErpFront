...
export const TenderList = () => {
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            if (created) navigate(`/sales/quotes/${created.id}`);
        } catch (e: any) {
            ...
            <InventoryListHeader
                ...
                action={
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {canManage && (
                            <Button variant="primary" icon={<Plus size={13} />} onClick={() => navigate('/sales/quotes/new')}>{i18nT('tenders.new_tender')}</Button>
                        )}
                    </div>
                }
            />
                    ...
                    <tbody>
                        ...
                        {!loadingList && list.map((t) => (
                            <tr
                                ...
                                onClick={() => navigate(`/sales/quotes/${t.id}`)}
                            >
                                <td>
