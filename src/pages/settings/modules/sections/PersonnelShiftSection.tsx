...
import type { ShiftPlan } from '@/pages/personnel/types/personnel';
import { useLanguageTick, useShiftPlan } from '@/pages/personnel/hooks/usePersonnel';
import { GhostButton, Labelled, PrimaryButton, SectionCard } from '@/pages/personnel/components/primitives';
import { formatHours, isoWeekdayLabel } from '@/pages/personnel/utils/format';
import {
    DEFAULT_SHIFT_PLAN,
    WEEKDAY_KEYS,
    WEEKEND_DAYS,
    ...
    netShiftMinutes,
    weeklyNetMinutes,
} from '@/pages/personnel/utils/personnel';

/**
 * ── SCHICHTPLANUNG (Einstellungen → Module → Personal) ──────────────────────
 *
 * Links wird geplant, rechts steht die PLANÜBERSICHT (Vorgabe): Arbeitstage je
 * Woche, Bruttoschicht, Pause, Tagesnetto, Wochennetto.
 *
 * SIE WAR EIN MENÜPUNKT und ist seit dem 26.08.2026 eine EINSTELLUNG: der Plan
 * wird einmal im Jahr angefasst und gilt für das ganze Haus — er gehört zu den
 * Feiertagen und zum Urlaubsanspruch, nicht zwischen die Listen, mit denen
 * täglich gearbeitet wird. `/personnel/shift-plan` leitet hierher.
 *
 ...
 * die Sollstunden, mit denen die Arbeitszeiterfassung später rechnet.
 *
